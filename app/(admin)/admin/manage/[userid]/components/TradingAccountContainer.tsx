"use client";
import useGetTradingAccountById from "@/hooks/useGetTradingAccountById";
...
const TradingAccountContainer = ({ userId }: { userId: string }) => {
  const { tradingAccount } = useGetTradingAccountById({ userId }) as any;
