  ...
  return (
    <form className="w-full flex flex-col gap-4 p-6" onSubmit={onSubmit}>
      ...
      <div className="w-full">
        ...
        <div className="relative h-fit">
          ...
          <InputTag
            ...
            className="w-full rounded-lg bg-background !px-6 placeholder:text-muted dark:placeholder:text-muted"
          />
        </div>
      </div>
      ...
      <div>
        ...
        >
          {isLoading && (
            <Loader className="mr-2 h-4 w-4 animate-spin bg-transparent" />
          )}
          <span> Deposit</span>
        </Button>
      </div>
